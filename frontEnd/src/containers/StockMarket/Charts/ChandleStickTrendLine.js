...
import TrendDetails from '../ComparisonUtils/TrendDetails';
import SlopeDetails from '../ComparisonUtils/SlopeDetails';
import styles from '../../../assets/css/StockMarket/ChartComponent.css';
...
class CandlestickChart extends React.Component {
	...
	onDrawCompleteChart1(trends_1) {
		...
		// console.log(this.state.trends_1);
	}
	...
	render() {
		...
		<div className={styles.container}>
			...
			<div className={styles.trendDetails_container}>
				<TrendDetails trend={this.state.trends_1} item={this.props.itemsToDisplay}/>
			</div>
			...
			<div className={styles.share_slope_container}>
				<div>
