...
import LandCardContainer from '../../Land/LandCardContainer/LandCardContainer';

class LandAdsContainer extends Component {
    state = {
        loading: true,
        longitude: 79.908937,
        latitude: 6.863285
            ...
            <div>
                {
                    ...
                    :
                        <div>
                            ...
                            <LandCardContainer getCo={this.getCoordinates} />
                        </div>
                }
            </div>
        )
...
export default LandAdsContainer;